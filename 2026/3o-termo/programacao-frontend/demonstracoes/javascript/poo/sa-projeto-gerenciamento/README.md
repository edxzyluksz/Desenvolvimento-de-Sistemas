...
**Versão:** 1.1.0  
**Data:** 2026-05-05  
**Autores:** Eduardo, GuizineRa e Liphyzz
...
|--------|------|-------|-------------|
| 1.0.0 | 2026-04-14 | Eduardo, Liphyzz e GuizineRa | Versão Inicial. |
| 1.1.0 | 2026-05-05 | Eduardo | Separação de CRUD (Create/Update), uso obrigatório de ID, permissão de perdas (-), Modais UI e Abas. |
