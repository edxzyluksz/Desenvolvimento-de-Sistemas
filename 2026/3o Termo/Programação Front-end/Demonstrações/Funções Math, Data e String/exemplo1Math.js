...
console.log(Math.random()); // Gera um Nº aleatório entre 0 e 1 incluindo decimais
console.log(Math.random() * 1000); // Gera um Nº aleatório entre 0 e 1000 
