...
* **Exemplos de (Adjuntos dos) Projetos:**
  * Capa de livro
  * Trailers e atores
  * LEDs e afins em equipamentos tecnológicos
...
* Ao considerar-se os **extras** de um software que melhorará a **experiência do usuário**:
...
* **Ações Iniciais:**
  * Definir claramente os **stakeholders** e suas expectativas.
...
* **ENCERRAMENTO DO PROJETO:**
  ...
  * **Enumerar lições aprendidas**.
  * Caso haja realmente uma conclusão **antecipada**, procure **negociar uma taxa em %**, para ganhar mais nesse sentido.
