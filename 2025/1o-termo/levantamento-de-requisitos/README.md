...
- Não ter gastos acima do necessário.
- Prever as necessidades do sistema.
- Critérios para entrega do **MVP**.
- Visualizar a demanda por completo.
- Pesquisa de mercado.
- Antever o sistema em seu começo, meio e fim.
- Melhoria contínua do projeto (5S).
...
O projeto do bolo é considerado **MVP** (cumpre sua função).

#### O Erro no LR

Minhas anotações sobre o bolo de laranja estão mais que imprecisas por não apontar as medidas dos ingredientes, mencionar a utilização de itens como espátulas e copos de medição, o modo de preparo e o gênero da laranja.

#### Detalhamento Correto (Maneira Adequada)

**Ingredientes Essenciais (Mínimos)**:
...
1. Pré-aquecer forno **180°C**.
2. Óleo, açúcar, ovos, suco laranja (liquidificador).
3. Transferir tigela, farinha e fermento.
4. Transferir assadeira untada (forma redonda de 15cm).
5. **35 minutos** de forno.
6. Desenformar para servir.
7. Deixar esfriar antes de consumir.
